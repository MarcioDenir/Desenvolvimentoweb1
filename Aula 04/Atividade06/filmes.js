...
function atualizarFilmes(){
    const titulo = readline.question("Informe o titulo do filme atualizado: ");
    const ano = readline.questionInt("informe o ano do filme atualizado: ");

    const update=`UPDATE filmes SET titulo = ?,ano = ? WHERE id =?`;

    const id=readline.questionInt("Informe o id do filme que deseja atualizar: ");
